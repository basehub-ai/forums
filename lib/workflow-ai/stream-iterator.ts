/**
 * source copied over from https://github.com/vercel/workflow
 * verbatim. the import from @workflow/ai was causing issues with the nextjs bundler
 * probably due to barrel exports.
 */
