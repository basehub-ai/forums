...
export function Header() {
  return (
    <header className="top-0 z-50 bg-linear-to-b from-50% from-background via-70% via-[rgba(var(--background-raw),0.70)] to-[rgba(var(--background-raw),0.00)] md:from-30% md:via-60%">
